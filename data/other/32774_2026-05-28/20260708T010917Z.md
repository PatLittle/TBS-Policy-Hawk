...
- Hierarchy CSV ID: 32774
- Source URL: https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/responsible-use-ai/algorithmic-impact-assessment.html
- Capture URL: https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/responsible-use-ai/algorithmic-impact-assessment.html
- Source date: 2026-05-28
- Source date basis: Canada.ca modified date metadata/page details
- Source date URL: https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/responsible-use-ai/algorithmic-impact-assessment.html
...
| Risk area | Description |
| --- | --- |
| About the system | Information about the system, such as its capabilities, who developed and configured it, and accountabilities for the system within the department. |
| Risk area | Description |
| --- | --- |
...
| 5. Impact | 20 | 52 |
| 6. Data | 16 | 55 |
| Raw impact score | 65 | 169 |
| Mitigation area | No. of questions | Maximum score |
| --- | --- | --- |
| 7. Consultations | 4 | 10 |
| 8. De-risking and mitigation measures | 37 | 67 |
| Mitigation score | 41 | 77 |
...
## 3. Instructions
The AIA is available as an [online questionnaire](https://open.canada.ca/aia) on the Open Government Portal. When the questionnaire is completed, the results provide an impact level and a link to the requirements under the directive. The detailed results page will also explain why the system was rated at a certain level. The results and the explanation can be printed or saved as a PDF.
...
[Section 6](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32592#cha6) of the directive provides a comprehensive list of the requirements that departments are responsible for. Some of the requirements increase for higher-impact levels, including the type of peer review and the extent of human involvement in the decisions. For a complete list of requirements that vary with the impact level, refer to the appendix [Impact Level Requirements](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32592#appC) in the directive. Other requirements are baseline requirements that do not vary according to the impact level, such as consulting with the institution’s legal services unit prior to the development of the system, testing and monitoring outcomes, and providing applicable recourse options to challenge the decisions.
...
- determine whether the automated decision system will make use of personal information as defined in section 3 of the [Privacy Act](https://laws-lois.justice.gc.ca/ENG/ACTS/P-21/page-1.html#h-397182)
...
- determine applicable requirements in the [Policy on Privacy Protection](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=12510) and supporting policy instruments, with the goal of ensuring that the appropriate safeguards are in place for the creation, collection and handling of personal information throughout the life cycle of the system, including plans for responsive action in the event of a privacy breach
- inform approaches to notifying the [Office of the Privacy Commissioner of Canada](https://www.priv.gc.ca/en/) of the proposed system and any foreseeable impacts on the privacy of Canadians, as required in the Policy on Privacy Protection
- ensure that any personal information collected or created by or for the automation project is demonstrably necessary for the program or activity, as required by the [Directive on Privacy Practices](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=18309)
...
- ensure that the AIA is reviewed by privacy officials prior to its publication on the Open Government Portal, in accordance with the [Directive on Open Government](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=28108)
...
Departments are encouraged to contact TBS OCIO at [ai-ia@tbs-sct.gc.ca](mailto:ai-ia@tbs-sct.gc.ca) for any questions regarding the directive or AIA.
