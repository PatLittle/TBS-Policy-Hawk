...
- Notice URL: https://www.canada.ca/en/treasury-board-secretariat/services/policy-notice/2013-2.html
- Notice modified: 2013-04-24
- Notice identifier: 2013-2
- Listed date: 
...
The entities that must report are contracting authorities as defined in the [Government Contracts Regulations](http://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/page-1.html#h-2).
...
Please send electronic data by e-mail to [ncr.gwprs@pwgsc.gc.ca](mailto:ncr.gwprs@pwgsc.gc.ca) and copy (cc:) [par-rsa@tbs-sct.gc.ca](mailto:par-rsa@tbs-sct.gc.ca). Alternatively, you can mail your electronic files on diskette to: PWGSC, 11 Laurier Street, Phase III Floor 14A2, Gatineau, Québec K1A 0S5, Attention: Gérard Degrève.
...
We ask departments to share their views on this by e-mailing [Gerard.Degreve@tpsgc-pwgsc.gc.ca](mailto:Gerard.Degreve@tpsgc-pwgsc.gc.ca) and with a copy (cc:) to [par-rsa@tbs-sct.gc.ca](mailto:par-rsa@tbs-sct.gc.ca) by May 31, 2013.
...
6. Country of Origin (organization must use the [ISO Alpha-3 code](http://unstats.un.org/unsd/methods/m49/m49alpha.htm))
