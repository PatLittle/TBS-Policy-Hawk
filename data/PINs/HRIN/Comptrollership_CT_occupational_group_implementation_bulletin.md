...
- Notice URL: https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/comptrollership-occupational-group-implementation-bulletin.html
- Notice modified: 2023-11-23
- Notice group: Active notices
- Listed date: 2023-08-16
...
A definition of the [CT](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups/comptrollership.html#grp-ct) group has been developed to include the [CT-IAU](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups/comptrollership.html#def-ct-iau), [CT-FIN](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups/comptrollership.html#def-ct-fin) and [CT-EAV](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups/comptrollership.html#def-ct-eav) subgroup definitions. The abbreviation chosen for the Comptrollership group, “CT”, has been selected in both English and French to meet federal bilingual requirements and emphasize the responsibilities of the work.

As part of the CT group implementation, two distinct classification renewal exercises will take place in the CPA:

### CT-IAU conversion

On September 28, 2023, all AS positions with internal audit work as primary purpose will undergo a conversion to the new CT-IAU subgroup. As part of this conversion exercise, a new [CT-IAU subgroup definition](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups/comptrollership.html#occ-iau), [job evaluation standard (JES)](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/job-evaluation/comptrollership-job-evaluation-standard.html#toc2) and [qualification standard](https://www.canada.ca/en/treasury-board-secretariat/services/staffing/qualification-standards/core.html#ct-iau) have been created.
...
On September 28, 2023, or in the days that follow, all [Official Personal Notifications (OPNs)](https://www.gcpedia.gc.ca/gcwiki/images/d/dc/CT-IAU_Conversion_OPN_Templates_and_Distr_Process_-_Mod%C3%A8les_NPO_et_processus_de_distr_BIL.docx.docx) must be distributed to employees currently occupying an AS position with whose primary purpose is internal audit work. These OPNs will serve as official notification regarding the conversion of their position to the new CT-IAU subgroup. The organizational classification team will provide guidance to management throughout this process.
...
Watermarked copies of the proposed CT-IAU ISJDs are not yet in effect but can be found on the [Internal Audit Communities](https://www.gcpedia.gc.ca/wiki/Internal_Audit_Communities/Classification) page on GCpedia. Organizational classification teams can access final version CT-IAU ISJDs in the [Conversion Initiatives](https://gcconnex.gc.ca/file/group/33520740/all#118495701)group in GCconnex. It is important to note that the effective ISJDs cannot be shared with employees prior to conversion.
...
As of September 28, 2023, the FI and AU qualification standards will be renamed to CT-FIN and CT-EAV respectively. There are no substantial changes to these qualification standards. However, some minor technical amendments have been proposed to align the wording with other qualification standards and to update the information in the occupational certifications, removing references to certification(s) that no longer exist. More information on qualification standards in the CT context can be found [here](https://intranet.canada.ca/hr-rh/pss-dfp/oew-oet/cr-rc-eng.asp#:~:text=Meeting%20new%20job%20requirements%20including%20qualification%20standards).
...
- Public Service Staffing - Advertisements and Notifications ([Government of Canada jobs](https://www.canada.ca/en/services/jobs/opportunities/government.html))
