...
- Notice URL: https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html
...
It provides information and direction for the implementation of the new Law Practitioner (LP) Classification Standard effective as of January 6, 2014.
...
A new classification standard for Law Practitioners (LP) to be effective on the date of the conversion January 6, 2014.
...
The [Salary administration policy - Law Group - Department of Justice and other excluded legal officers](http://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=12115) is rescinded effective January 6, 2014.
...
The date of the classification conversion from LA to LP is January 6, 2014.

### a) Reclassifications

Any position being reclassified as a result of the re-writing of a work description must be evaluated within the LA Classification Standard no later than January 3, 2014. Subsequently, these reclassified LA positions must be converted to the new LP structure effective January 6, 2014.
...
No later than the week of January 6, 2014, departments and agencies will provide all employees occupying an LA position, with a letter informing them of the new group and level of their position. This letter is referred to as an Official Personal Notification (OPN). A template letter is available in [Appendix A](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#AppendixA) of this bulletin.
...
Given the LA Classification Standard will cease to exist as of January 6, 2014, all LA pay files along with managerial or confidential positions must be updated as well.
...
TBS has prepared a suite of communication products to inform managers and employees of this initiative. Departments and agencies may adapt the products to better reflect their operational needs. See [Appendix B](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#AppendixB) for speaking points for managers and frequently asked questions for employees.

A crosswalk table demonstrating the change from the LA to LP classification structure is also provided in [Appendix C](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#AppendixC).
...
The LP designation is to be used in all HR systems including those for the Public Service Employment Surveys, Job.gc.ca, Publiservice Public Service Staffing - Advertisements & Notifications, registration for courses at the Canada School of Public Service, management of priorities, etc.
...
The conversion date is January 6, 2014.

In accordance with the [Policy on Classification System and Delegation of Authority](http://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=12098), a conversion is a one-time event that must be declared by TBS. This bulletin provides departments and agencies with the authority to convert LA positions to LP.
...
- [Law Practitioner Occupational Group Definition](https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/occupational-groups.html#lp)
- [Law Practitioner Qualification Standard](https://www.canada.ca/en/treasury-board-secretariat/services/staffing/qualification-standards/core.html#LP)

The [LP Classification Standard](http://www.tbs-sct.gc.ca/cla/lp/cs-nc-eng.asp), the qualification standards and occupational group definition are available on the [Publiservice Conversion site](http://publiservice.tbs-sct.gc.ca/cla/conv-eng.asp).
...
A/Assistant Deputy Minister Compensation and Labour Relations Office of the Chief Human Resources Officer

## Appendix A: Official Personal Notification Template

January 6, 2014

Employee Name Employee PRI
...
Your substantive / acting position number xxxx-xxx, currently classified at the LA-xx level, will be converted to the LP-xx level effective January 6, 2014.
...
- The Law Practitioner (LP) Classification Standard comes into effect on January 6, 2014.
...
Issue: The restructure of the Law (LA) Group resulted in two new classification standards, one for managers and another for practitioners. The new Law Practitioner (LP) Classification Standard comes into effect January 6, 2014.
...
#### 4. Will the LA Group still exist after January 6, 2014?
...
More information on the new [LP standard](https://www.canada.ca/en/treasury-board-secretariat/topics/collective-agreements/job-evaluation.html) is available on the TBS website.

## Appendix C: Crosswalk Table from LA to LP

| Law (LA) Group and Level | New Law Practitioner (LP) Group and Level Conversion Date Jan 6, 2014 | Rates of Pay[Footnote 1](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#fn1) All Regions except Toronto Collective Agreement Effective May 10, 2013 | Rates of Pay[Footnote 1](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#fn1) Toronto Region Collective Agreement Effective May 10, 2013 |
| --- | --- | --- | --- |
| Footnotes Footnote 1 Lock step rates are included in [Appendix A: LA - Law Group Annual Rates of Pay](http://www.tbs-sct.gc.ca/pubs_pol/hrpubs/coll_agre/la/la02-eng.asp#toc258484882) of the collective agreement. [Return to first footnote 1 referrer](https://www.canada.ca/en/treasury-board-secretariat/services/information-notice/implementation-new-law-practitioner-classification-standard-conversion.html#fn1a-rf) |  |  |  |
...
| LA-00 Articling Students | LP-00 Articling Students | LP-DEV $36,172 to $78,970 | LP-DEV $36,172 to $78,970 |
