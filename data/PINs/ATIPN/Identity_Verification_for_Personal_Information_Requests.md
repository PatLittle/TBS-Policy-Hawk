...
- Notice URL: https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information-privacy-notices/2022-02-identity-verification.html
...
Each institution is responsible for establishing its own procedures to validate the identity of the requesters. Annex A provides guidance on steps to consider in establishing these procedures. Annex A’s focus is on the procedure in general, not identity verification for a specific request. Treasury Board of Canada Secretariat’s (TBS) Cyber Security team has also developed a [Guideline on Identity Assurance](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=30678), a [Guideline on Defining Authentication Requirements](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=26262), and a tool to determine [Assurance Level Requirement](https://canada-ca.github.io/gcdigital-tools_outils-numeriquesgc/views-vues/assurance-level-requirement/en/assurance-level-requirement.html). They support the requirements within the Directive on Identity Management.

Annex B provides a chart articulating the sensitivity of information and the commensurate level of assurance required for its release. It is taken from the [Guideline on Identity Assurance](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=30678).
...
- [Official Languages Act](https://laws-lois.justice.gc.ca/eng/acts/O-3.01/page-2.html#h-384283)
- [Privacy Act](http://laws-lois.justice.gc.ca/eng/acts/P-21/)
- [Privacy Act Extension Order, No. 3](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2021-174/page-1.html)
- [Privacy Regulations](https://laws-lois.justice.gc.ca/eng/regulations/SOR-83-508/page-1.html#h-878596)
...
- [Directive on Personal Information Requests and Correction of Personal Information](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32590)
- [Directive on Service and Digital](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32601)
- [Directive on Social Insurance Number](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=13342)
...
- [About identity verification requirements (PSPC)](https://www.tpsgc-pwgsc.gc.ca/esc-src/personnel/propos-id-eng.html)
- [Assurance Level Requirement (TBS)](https://canada-ca.github.io/gcdigital-tools_outils-numeriquesgc/views-vues/assurance-level-requirement/en/assurance-level-requirement.html)
- [GDPR on identity verification](https://dpnetwork.org.uk/subject-access-requests-proof-of-id/)
- [Guideline on Defining Authentication Requirements (TBS)](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=26262)
- [Guideline on Identity Assurance (TBS)](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=30678)
- [Methods to verify the identity of persons and entities (FINTRAC)](https://www.fintrac-canafe.gc.ca/guidance-directives/client-clientele/Guide11/11-eng)
- [Notary Services (GAC)](https://www.canadainternational.gc.ca/japan-japon/consular_services_consulaires/notarial-notariat.aspx?lang=eng)
- [Pre-boarding identification requirements (CBSA)](https://travel.gc.ca/air/identification-requirements)
- [Privacy Breach Management (TBS)](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/privacy/breach-management.html)
- [Provincial definitions of a minor (IRCC)](https://www.canada.ca/en/immigration-refugees-citizenship/corporate/publications-manuals/operational-bulletins-manuals/refugee-protection/canada/processing-provincial-definitions-minor.html)
...
- [Tools to help determine authentic documents (PSPC)](https://www.tpsgc-pwgsc.gc.ca/esc-src/personnel/propos-id-eng.html#a4)
...
ATIP coordinators may contact the Treasury Board of Canada Secretariat's [Privacy and Data Protection Division](mailto:ippd-dpiprp@tbs-sct.gc.ca) for information about this implementation notice.
...
Perform a risk analysis of the level of sensitivity of the types of information that will be disclosed. TBS has developed a [Credential Assurance Level Tool](https://canada-ca.github.io/gcdigital-tools_outils-numeriquesgc/views-vues/assurance-level-requirement/en/assurance-level-requirement.html) that can be used to assist in this regard.
...
The Social Insurance Number is not an identity document but may be requested by specific institutions if the request seeks information about employment, government benefit programs and/or services and taxation purposes. (For additional information on the collection and use of the SIN, please refer to the [Directive on Social Insurance Number](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=13342).)

The Financial Transaction and Reports Analysis Centre of Canada (FINTRAC) provides more guidance on acceptable identity documents in their [Methods to verify the identity of persons and entities](https://www.fintrac-canafe.gc.ca/guidance-directives/client-clientele/Guide11/11-eng).

If a requester’s identity has previously been verified within the institution as part of a different program or service, a file number or case number may have already been assigned to them. Institutions may wish to require this file number or unique identifier as part of a request: this will help to confirm the requester’s identity. This type of information is already identified in the [Standard PIB: PSU 901 - Access to Information Act and Privacy Act Requests](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-personal-information-banks.html#psu901).
...
Verifying the identity of the individual making a request includes confirming the authenticity of the documents presented to ensure they are not counterfeit. Authenticity is defined in Public Services and Procurement Canada’s [About identity verification requirements](https://www.tpsgc-pwgsc.gc.ca/esc-src/personnel/propos-id-eng.html).
...
As per s. 22 of the [Official Languages Act](https://laws-lois.justice.gc.ca/eng/acts/O-3.01/page-2.html#h-384283), federal institutions must ensure that any member of the public can communicate with and obtain available services in either of Canada’s official languages. If the identity documents are in neither English, nor French, the institution may request a translated notarized copy, along with a copy of the document in the other language. Canadian embassies provide [notarial service](https://travel.gc.ca/travelling/documents/notarial-services) in some countries.
...
Institutions should periodically review their procedures to confirm whether they remain appropriate to the types of requests they are receiving and the information they are disclosing. This is especially important given that a new population of requesters will begin to have access with the coming into force of the [Privacy Act Extension Order, No. 3](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2021-174/page-1.html).

## Annex B: Assurance Level Guidelines for Evidence of Identity

From the [Guideline on Identity Assurance](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=30678)

| Requirement | Level 1 | Level 2 | Level 3 | Level 4 |
| --- | --- | --- | --- | --- |
| Uniqueness | Define identity information Define context | Define identity information Define context | Define identity information Define context | Define identity information Define context |
