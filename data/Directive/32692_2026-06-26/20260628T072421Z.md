...
, which took effect on May 13, 2021, replaced the following instruments:
...
* Effective April 1, 2022, to include a new Appendix E: Mandatory Procedures for Contracts Awarded to Indigenous Businesses that describes procedures to address the Government of Canada’s requirement that a
  [minimum of 5% of the total value of contracts](https://www.canada.ca/en/public-services-procurement/news/2021/08/government-of-canada-announces-federal-wide-measures-to-increase-opportunities-for-indigenous-businesses.html)
  is awarded to Indigenous businesses annually;
* Effective April 1, 2023, to integrate human rights, the environment, social and corporate governance, supply chain transparency principles, and Public Services and Procurement Canada’s
  *[Code of Conduct for Procurement](https://www.canada.ca/en/public-services-procurement/services/acquisitions/supplier-conduct/code.html)*
  into all government procurements;
* Effective June 30, 2023, to add requirements for risk-based systems of internal control, information management and proactive publication of contracts, and to reflect that the
  *Guidelines on the Proactive Disclosure of Contracts*
  have been updated and renamed
  *[Guide to the Proactive Publication of Contracts](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32763)*
  ;
...
* Effective December 4, 2025, to reflect Public Services and Procurement Canada’s exclusive authority for the procurement of goods, services and construction, further to amendments to the [*Department of Public Works and Government Services Act*](https://laws-lois.justice.gc.ca/eng/acts/p-38.2/);
* Effective December 15, 2025, to increase most contracting limits in "Appendix A: Contracting Approvals" to reflect inflation;
* Effective December 16, 2025, to reflect the Buy Canadian Procurement Policy Framework, under the responsibility of Public Services and Procurement Canada;
* Effective April 30, 2026, to reduce reporting burden and streamline departmental reporting requirements.
...
* 4.1Senior designated officials for the management of procurement are responsible for the following:
  ...
  + 4.1.2Ensuring that the departmental procurement management framework:
    ...
    - 4.1.2.5Contributes the procurement perspective to departmental planning functions and ensures that procurement strategies in the investment plan are in accordance with the
      [*Policy on the Planning and Management of Investments*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32593)
    ...
    - 4.1.2.12Gives precedence to competition in accordance with the
      [*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
      and trade agreements;
    - 4.1.2.13Facilitates the collection and publication on the
      [Open Government portal](https://open.canada.ca/en)
      of accurate, timely and complete data for corporate reporting on procurement as described in Appendix C: Mandatory Procedures for the Proactive Publication of Contract Information and Reporting;
    ...
    - 4.1.2.17Incorporates, when procuring under a delegated authority from the Minister responsible for Public Services and Procurement Canada:
      * 4.1.2.17.1Practices, procedures, reporting, and minimum training requirements to comply with any terms and conditions that may be established in their delegation instrument; and,
      * 4.1.2.17.2Direction, systems, policies, tools, templates, procedures and guidance prescribed by Public Services Procurement Canada for use by departments.
...
* 4.2Business owners are responsible for the following:
  ...
  + 4.2.2Adhering to the
    ...
    at all times during the procurement process, including but not limited to when engaging with suppliers, evaluating bids, awarding and managing contracts;
  ...
  + 4.2.7Ensuring that the intended outcomes of the procurement are aligned with the departmental mandate and government priorities, available funds, and key socio-economic and environmental benefits:
    ...
    - 4.2.7.2Where appropriate, including environmental considerations when specifying requirements for goods, services and construction and leveraging procurement practices in accordance with the
      [*Policy on Green Procurement*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32573)
      and documenting files accordingly;
...
* 4.3Contracting authorities are responsible for the following:
  ...
  + 4.3.9Incorporating the
    [Code of Conduct for Procurement](https://www.canada.ca/en/public-services-procurement/services/acquisitions/supplier-conduct/code.html)
    into procurements (refer to Annex D6: Code of Conduct for Procurement).
...
* 4.5Contracting authorities are responsible for the following:
  + 4.5.1Ensuring that bids are solicited for contracts, except when one of the exceptions set out in the
    [*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
    applies;
...
* 4.9Business owners are responsible for the following:
  ...
  + 4.9.6In collaboration with contracting authorities, providing a justification for using any of the exceptions to soliciting bids in the
    [*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
    .
* 4.10Contracting authorities are responsible for the following:
  + 4.10.1Ensuring that accurate and comprehensive procurement records applicable to the contract file are created and maintained to facilitate management oversight and audit, including but not limited to:
    ...
    - 4.10.1.4Justification for using a non-competitive process, in accordance with the
      *[Government Contracts Regulations](https://laws-lois.justice.gc.ca/eng/regulations/sor-87-402/)*
      (including the sole source exception invoked, the rationale for its use, and any associated documentation);
  ...
  + 4.10.2Including a condition in complex procurements that prohibits the contractor from supplying goods to the government of Canada that is subject to economic sanctions imposed under the
    ...
    and listed in Appendix D: Requirements Included in Other Policies, Programs and Agreements That Impact Procurements, section D.4 (International sanctions), subsection D.4.2;
...
* 4.11Contracting authorities are responsible for the following:
  ...
  + 4.11.3Ensuring that any company selected to provide that financial security is licensed to provide it in the jurisdiction of the eventual contract, in accordance with the
    *Guidance on Source Lists of Companies Licensed to Provide Surety Within Canada*
    ;
...
* 4.14In accordance with the
  [*Official Languages Act*](https://laws-lois.justice.gc.ca/eng/acts/o-3.01/)
  and the
  [*Official Languages (Communications with and Services to the Public) Regulations*](https://laws.justice.gc.ca/eng/regulations/sor-92-48/index.html)
...
* 4.17Business owners, in collaboration with contracting authorities are responsible for the following:
  ...
  + 4.17.4Requiring that suppliers and subcontracted suppliers of goods and services apply ethical and sustainability standards across their supply chains and adhere to the
    [*Code of Conduct for Procurement*](https://www.tpsgc-pwgsc.gc.ca/app-acq/cndt-cndct/cca-ccp-eng.html)
    (refer to Annex D6: Code of Conduct for Procurement).
...
* 5.2**Department of Justice Canada is responsible for the following**
  ...
  + 5.2.2Where the
    [*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
    apply, contracts for legal services may be entered into only by or under the authority of the Minister of Justice; this requirement does not apply to contracting authorities included in the schedule to the
    [*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
    .
* 5.3**The Canada Revenue Agency (CRA) is responsible for the following**
  ...
  + 5.3.1Administering Canadian income tax and commodity tax (for example the Goods and Services Tax (GST) and Harmonized Sales Tax (HST)) legislation and regulations, and the related CRA policies and procedures, including with respect to:
    - 5.3.1.1[Required withholding from amounts paid to non-residents providing services in Canada](https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/ic75-6/required-withholding-amounts-paid-non-residents-providing-services-canada.html)
      , other than amounts paid in respect of an office of employment;
...
* 5.6**Public Services and Procurement Canada is a common service provider and is responsible for the following**
  :
  + 5.6.1Planning and organizing the acquisition and provision of goods and services, including construction services, for departments in accordance with applicable law;
  + 5.6.2Investigating and developing services for increasing the efficiency and economy of the federal public administration and for enhancing integrity and efficiency in the contracting process in accordance with applicable law;
  + 5.6.3Exercising exclusive authority for procuring goods and services, including construction services, for the use of any department, except to the extent that those powers have been delegated by the Minister responsible for Public Services and Procurement Canada, in accordance with applicable law;
  + 5.6.4Acquiring defence supplies and constructing defence projects as defined in the
    [*Defence Production Act*](https://laws-lois.justice.gc.ca/eng/acts/d-1/)
    with the exception of defence projects constructed by employees of Her Majesty, or purchasing defence supplies or constructing defence projects that the Minister responsible for Public Services and Procurement Canada requests that another Minister undertake;
  + 5.6.5Developing operational direction, policies, and procedures to support procurement undertaken by or on behalf of other government departments, such as guidance, templates, standard contract clauses, and an electronic tendering system;
  + 5.6.6As appropriate, designating the operational direction, policies, and procedures mandatory for use by departments when procuring under a delegation from the Minister responsible for Public Services and Procurement Canada;
  + 5.6.7If deemed necessary, determining and monitoring any appropriate compliance measures associated with terms and conditions imposed on departments in receipt of a delegated authority from the Minister responsible for Public Services and Procurement Canada.
  + 5.6.8Providing advice on:
    - 5.6.8.1Methods and support approaches for early engagement with industry;
    - 5.6.8.2Procurement strategies and industry barrier reduction;
  + 5.6.9Administering the
    ...
    , in collaboration with the Treasury Board of Canada Secretariat and Indigenous Services Canada; and
  + 5.6.10Advising contracting authorities and business owners on federal procurement activities in Comprehensive Land Claim Settlement Areas; and
  + 5.6.11Administering the
    [Ineligibility and Suspension Policy](https://www.canada.ca/en/public-services-procurement/services/standards-oversight/supplier-integrity-compliance/ineligibility-suspension-policy.html)
    (see Appendix D.6: Ineligibility and Suspension Policy).
* 5.7**Shared Services Canada is a common service provider and is responsible for the following**
  ...
  + 5.7.2Planning, organizing, and acquiring related goods and services pursuant to section 7 of the
...
* 5.8**Crown-Indigenous Relations and Northern Affairs Canada is responsible for the following**
  ...
  + 5.8.2Leading consultations with the Designated Inuit Organization about the development and maintenance of the
    [*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32610)
    and the development of any amendments; and
  + 5.8.3Advising on duty to consult.
* 5.9**Employment and Social Development Canada is responsible for the following**
  :
  + 5.9.1Leading and administering the
...
* 5.11**Indigenous Services Canada is responsible for the following**
  :
  + 5.11.1Leading and administering the
    *Procurement Strategy for Indigenous Business;*
  + 5.11.2Administering the
    [*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32610)
    , in collaboration with the Treasury Board of Canada Secretariat and Public Services and Procurement Canada;
...
* 5.13**Natural Resources Canada is responsible for the following:**
  + 5.13.1Assisting federal government departments under the
    [NRCan Greening Government Services](https://www.nrcan.gc.ca/energy-efficiency/buildings/nrcans-greening-government-services/3705)
    to improve the energy efficiency of their facilities without compromising the work environment of employees.

## 6. Application

* 6.1This directive applies to the organizations described in section 6 of the
  [*Policy on the Planning and Management of Investments*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32593)
  .
* 6.2This directive applies to all Government of Canada procurements as defined in the
  [*Policy on the Planning and Management of Investments*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32593)
  .
* 6.3This directive applies to all departments listed in Schedules I, I.1 and II of the
  [*Financial Administration Act*](https://laws-lois.justice.gc.ca/eng/acts/F-11/)
  (with the exception of the Canada Revenue Agency) and to any commissions established pursuant to the
  [*Inquiries Act*](https://laws-lois.justice.gc.ca/eng/acts/i-11/)
  and designated as a department for the purposes of the
  [*Financial Administration Act*](https://laws-lois.justice.gc.ca/eng/acts/F-11/)*.*
...
* 6.5The following transactions are not covered in this directive:
  ...
  + 6.5.7Leases and contracts for the fit-up of an office or residential accommodation pursuant to the
    [*Federal Real Property and Federal Immovables Act*](https://laws.justice.gc.ca/eng/acts/f-8.4/)
...
* 6.7In the event of a conflict between a requirement in this directive and a requirement in any other departmental policy instrument for procurement management, with the exception of the
  [*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32610)
  , the requirement in the
  *Directive on the Management of Procurement*
  will apply. In the event of a conflict between a requirement in this directive and a legal obligation, including an obligation under a modern treaty, the legal obligation will apply.
...
* 8.3Individuals from the departmental procurement policy group may contact
  Procurement Management Enquiries
  for interpretations.
...
This appendix is mandatory as prescribed by the Treasury Board. It applies to contracting authorities as defined in the
[*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
with the exception of contracting authorities in the Schedule to the Regulations and Commissions created pursuant to the
[*Inquiries Act*](https://laws-lois.justice.gc.ca/eng/acts/i-11/)
.
...
A contract or contractual arrangement may be entered into without the approval of the Treasury Board, if the amount payable, including all applicable taxes, fees and amendments, does not exceed the stated limit in
**Canadian dollars**
for the contracting authority identified in the basic limits schedules.
...
Thresholds for contracting in the
[*Government Contracts Regulations*](https://laws-lois.justice.gc.ca/eng/regulations/SOR-87-402/)
and in trade agreements must be adhered to, where applicable.
...
Related to the
[*Prairie Farm Rehabilitation Act*](https://laws-lois.justice.gc.ca/eng/acts/P-17/page-1.html)
:
...
* Competitive contracts up to $5,000,000 to implement a Minister’s order under the
  *Health of Animals Act*
  and the
  *Plant Protection Act*
  in response to a threat to Canada’s food safety, animal health or plant health
...
* Non-competitive service contracts and contractual arrangements, where the total value does not exceed $45,000,000 and for which the Correctional Service of Canada already has the statutory authority as per sections 16 and 81 of the
...
### Privy Council Office (including the Major Projects Office)

* For services contracts related to the Authorization of a National Interest Project by the Major Projects Office up to $500,000.
...
* A.4.1Contracting authorities are responsible for the following:
  + A.4.1.1Obtaining the responsible Minister’s approval before entering into a non-competitive service contract with a former public servant:
    - A.4.1.1.1In receipt of a pension under the
      [*Public Service Superannuation Act*](https://laws-lois.justice.gc.ca/eng/acts/p-36/)
      when the estimated total contract exceeds $200,000, including all amendments, applicable taxes and fees, or
    - A.4.1.1.2In receipt of a pension under the
      [*Public Service Superannuation Act*](https://laws-lois.justice.gc.ca/eng/acts/p-36/)
      , when the annualized rate of remuneration exceeds $200,000, including all applicable taxes and fees, and the contract term exceeds 90 working days; or
    - A.4.1.1.3In receipt of a lump-sum payment when the total fees payable will exceed $5,000 during the lump-sum payment period as provided in the
      [*Work Force Adjustment Directive*](https://www.njc-cnm.gc.ca/directive/d12/en)
      made pursuant to the
      [*Public Sector Compensation Act*](https://laws-lois.justice.gc.ca/eng/acts/p-31.6/)
      ; or who are former members of the Canadian Armed Forces and the Royal Canadian Mounted Police in receipt of lump-sum payments through corresponding force reduction programs, regardless of whether one or more than one contract is involved.
...
* A.7.6The Treasury Board of Canada Secretariat reserves the right to request a revalidation or review of the current mandatory standing offers and supply arrangements on a set timeframe following the effective date of the
  *Directive on the Management of Procurement*
  .
...
* B.1.4Paragraphs B.1.2.1.2 and B.1.2.2 and Table B.1 do not apply to contracts or contractual arrangements with Indigenous small businesses or Indigenous individuals for services related to the Authorization of a National Interest Project by the Major Projects Office if the Major Projects Office Chief Executive Officer has approved the indemnification.
...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Table 1 Notes Table 1 Note \*  Notes \* CFO stands for chief financial officer.  [Return to table 1 note \* referrer](#table1-fn1-rf)  Table 1 Note 1  Basic and exceptional limits apply. Subject to the goods delegations, including those for emergency provisions where specified, from Public Services and Procurement Canada and Shared Services Canada, as applicable.  [Return to table 1 note 1 referrer](#table1-fn2-rf) | | | | | |
...
* C.2Senior designated officials for the management of procurement are responsible for the following:
  + C.2.1Proactively publishing information on contracts in accordance with Part 2 of the
    [*Access to Information Act*](https://laws-lois.justice.gc.ca/eng/acts/a-1/)
    and any associated policies, directives or guidelines, including the
    [Guide to the Proactive Publication of Contracts](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32763)
    ;
  ...
  + C.2.5Proactively publishing the following contract information on a website designated by the Treasury Board of Canada Secretariat:
    ...
    - C.2.5.2Publishing for each fiscal year, by September 30th of the following fiscal year, the aggregate total value of all contracts valued at $10,000 and under, the aggregate total value of all positive or negative amendments valued at $10,000 and under, and all acquisition card transactions;
  + C.2.6Providing an annual report to Public Services and Procurement Canada and the Treasury Board of Canada Secretariat, by September 30 of the following fiscal year, on each contract entered into by or for the department valued at $10,000 and under, and on positive or negative contract amendments valued at $10,000 and under;
  ...
  + C.2.7Providing quarterly reports to fulfill the legal obligations of modern treaties and the policy requirements;
    - C.2.7.1Contacting the Business Development Division of Indigenous Services Canada at
      aadnc.clcanet.aandc@canada.ca
      for enquiries on any of the following:
...
* D.1.2Contracting authorities are responsible for the following:
  ...
  + D.1.2.3Determining which obligations apply by consulting the list of
    [Final Agreements relating to Comprehensive Land Claims and Self-Government](https://www.rcaanc-cirnac.gc.ca/eng/1100100030583/1529420498350)
    and the
    [Aboriginal and Treaty Rights Information System](https://sidait-atris.aadnc-aandc.gc.ca/atris_online/home-accueil.aspx?lang=en)
    relating to potential or established Aboriginal or treaty rights; and
  + D.1.2.4Documenting their assessment of the applicable procurement-related requirements in modern treaty.
* D.1.3In addition to modern treaties, the
  [*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32610)
  sets out the administrative requirements regarding government contracts and leases in the Nunavut Settlement Area stemming from the obligations in Article 24 of the Nunavut Agreement (
  [Agreement Between the Inuit of the Nunavut Settlement Area and Her Majesty the Queen in Right of Canada](http://publications.gc.ca/collections/Collection/R32-134-1993E.pdf)
  ).
...
* D.2.1Contracting authorities are responsible for:
  ...
  + D.2.1.3Consulting the
    [Policy Notices and Treasury Board Circulars–Contracting page](https://www.canada.ca/en/treasury-board-secretariat/services/policy-notice.html)
    for up-to-date information about trade agreements that Canada is party to, including government procurement obligations and current trade agreements thresholds in Canadian funds.
...
* D.3.1Contracting authorities are responsible for the following:
  ...
  + D.3.1.2Ensuring that a supplier with a resident workforce in Canada of 100 or more employees has a valid agreement to implement employment equity under the Federal Contractors Program before entering into a contract valued at $1,000,000 or more. The list of certified employers is available on the
    [Federal Contractors Program GCpedia page](http://www.gcpedia.gc.ca/wiki/Federal_Contractors_Program)
    (accessible only on the Government of Canada network);
  + D.3.1.3Ensuring that a supplier who qualifies for the
    [Federal Contractors Program](https://www.canada.ca/en/employment-social-development/programs/employment-equity/federal-contractor-program.html)
...
* D.4.2For the list of countries or groups that are subject to Canadian economic sanctions, refer to
  [current sanctions imposed by Canada](http://www.international.gc.ca/world-monde/international_relations-relations_internationales/sanctions/current-actuelles.aspx?lang=eng)
  .
...
* D.6.1Public Services and Procurement Canada (PSPC) is responsible for the following:
  + D.6.1.1Developing, administering and maintaining the
    [*Ineligibility and Suspension Policy*](https://www.canada.ca/en/public-services-procurement/services/standards-oversight/supplier-integrity-compliance/revised-ineligibility-suspension-policy.html)
    ;
  + D.6.1.2Declaring a supplier either ineligible to be, or suspended from being, awarded a contract with Canada in accordance with the
    [*Ineligibility and Suspension Policy*](https://www.canada.ca/en/public-services-procurement/services/standards-oversight/supplier-integrity-compliance/revised-ineligibility-suspension-policy.html)
    ; and
...
* procedures to address the Government of Canada’s
  [commitment](https://www.canada.ca/en/public-services-procurement/news/2021/08/government-of-canada-announces-federal-wide-measures-to-increase-opportunities-for-indigenous-businesses.html)
  that a mandatory minimum target of 5% of the total value of contracts is awarded to Indigenous businesses (“5% target”) annually;
* procedures for:
...
This commitment also supports the requirements set out in subsection 4.1.3.6 of the Treasury Board
[*Policy on the Planning and Management of Investments*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32593)
to uphold the obligations of the Crown with respect to Indigenous peoples. These obligations include Canada’s procurement obligations arising from multiple comprehensive land claims agreements (CLCAs). In the event of a conflict between a requirement in these mandatory procedures and a legal obligation, including an obligation under a CLCA, the legal obligation will apply.

These procedures should also be read in conjunction with the Treasury Board
*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*
. In the event of a conflict between a requirement in these mandatory procedures and a requirement in the
*Directive on Government Contracts, Including Real Property Leases, in the Nunavut Settlement Area*
, the requirement in the directive will apply.

Departments are to meet or exceed the 5% target no later than the fiscal year-end of 2024–25, as set out in the schedule prescribed by Indigenous Services Canada for when departments are required to meet the 5% target. This schedule is based on an assessment of departments’ levels of readiness to meet the 5% target using prior departmental procurement plans related to the
*Procurement Strategy for Indigenous Business*
.
...
* E.2.1These procedures provide details on the requirements set out in subsection 4.1.2.1 of the Treasury Board
  [*Directive on the Management of Procurement*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32692)
  for departmental senior designated officials for the management of procurement to establish oversight, planning and reporting mechanisms of departmental procurement management frameworks that support the Government of Canada commitment for a mandatory minimum target for contracts awarded to Indigenous businesses as a proportion of the total value of contracts awarded (“mandatory minimum target”).
* E.2.2Mandatory procedures are as follows:
  ...
  + E.2.2.1Departmental procurement management frameworks are to include oversight, planning and reporting mechanisms that:
    ...
    - E.2.2.1.2Identify to common service providers, as defined in the Treasury Board
      [*Policy on the Planning and Management of Investments*](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32593)
      , the procurement tools required of them to support achievement of procurement plans for meeting the mandatory minimum target, as appropriate.
  ...
  + E.2.2.2Departmental procurement management frameworks are to include oversight, planning and reporting mechanisms that:
    ...
    - E.2.2.2.5Ensure fulfillment of the requirements of the
      *Procurement Strategy for Indigenous Business*
      ; and
    - E.2.2.2.6Ensure the recording of timely, accurate and complete contracting information on contracts awarded to Indigenous businesses in conjunction with Appendix C.2 of this directive and when reporting to Parliament, in the format specified by the Treasury Board of Canada Secretariat.
  ...
  + E.2.2.3Departmental procurement management frameworks are to include oversight, planning and reporting mechanisms that ensure the following:
    ...
    - E.2.2.3.3Calculations in subsections E.2.2.3.1 and E.2.2.3.2 apply to contracts, as defined in the Treasury Board
      *Policy on the Planning and Management of Investments,*
      and the mandatory minimum target is not to be applied to each individual contract; and
    - E.2.2.3.4Information on departmental performance is validated against the mandatory minimum target and is published within 12 months after fiscal year-end, in coordination with Indigenous Services Canada’s publication on government-wide performance (refer to subsection E.3.5.2).
...
* E.3.4Shared Services Canada is responsible for the following:
  + E.3.4.1Providing services as described in subsection 5.3.1 of the Treasury Board
    *Directive on the Management of Procurement*
    ; and
  + E.3.4.2Developing and evolving procurement tools, such as standing offers, supply arrangements, and other tools that pertain to the participation of Indigenous businesses when implementing activities pursuant to section 7 of the
    *Shared Services Canada Act*
    , as described in subsection 5.3.2 of the Treasury Board
    *Directive on the Management of Procurement*
    .
* E.3.5Indigenous Services Canada is responsible for the following:
  + E.3.5.1Prescribing the schedule for when departments are to meet the mandatory minimum target based on an assessment of departmental level of readiness to meet the mandatory minimum target using prior departmental procurement plans related to the
    *Procurement Strategy for Indigenous Business*
    ;
  + E.3.5.2Publishing information on government-wide performance against the mandatory minimum target within 12 months after fiscal year-end;
  + E.3.5.3Implementing and advising on the
    *Procurement Strategy for Indigenous Business*
    ; and
  + E.3.5.4Assisting in identifying and building Indigenous business capacity and supporting coordinated government-wide outreach and assistance to Indigenous businesses.
...
For interpretation of any aspect of these mandatory procedures, contact the
[Treasury Board of Canada Secretariat](https://www.canada.ca/en/treasury-board-secretariat/corporate/contact.html#toc02)
.

For information regarding the Government of Canada’s Indigenous Business Directory and Procurement Strategy for Indigenous Businesses, contact Indigenous Services Canada at
indigenousprocurement@sac-isc.gc.ca
.

For information regarding the Government of Canada’s procurement processes and practices, contact Public Services and Procurement Canada at
TPSGC.PAApprovisionAutochtone-APIndigenousProc.PWGSC@tpsgc-pwgsc.gc.ca
.

For information regarding services provided by Shared Services Canada, contact Shared Services Canada at
eitpdgo.atiebdg@ssc-spc.gc.ca
.
...
* F.2Procedures
  ...
  + F.2.4Consider and document alternative approaches to procurement for achieving organizational goals as well as how the potential procurement approach aligns with their organization’s mandate, priorities and plans, including:
    ...
    - If the requirement involves digital talent, follow the Mandatory Procedures contained in the
  ...
  + F.2.5Seek approval, in accordance with governance and accountabilities laid out in the departmental Investment Plan, including but not limited to the departmental:
    - Procurement Management Framework as set out in the
      *Directive on the Management of Procurement*
      ; and
    - If applicable, the Project Management Framework as set out in the
  ...
  + F.2.7Before awarding any contract or task authorization for a professional service, business owners are to provide contracting authorities with the following:
    ...
    - F.2.7.2Signed confirmation that they have reviewed the contract or task authorization and acknowledge the following:
      ...
      * That they do not have any potential, perceived or real conflicts of interest, and that should any develop they will immediately report it as required by the
        *[Directive on Conflict of Interest](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32627)*
        and notify the contracting authority.

    #### Managing a contract for professional services
  + F.2.8Business owners are to:
    - F.2.8.1Ensure the active monitoring of the day-to-day performance of the work of the contractor, including continued compliance with the security requirements of the contract, as required in the
    ...
    - F.2.8.2Report in writing to the contracting authority:
      ...
      * As soon as they suspect or know that a supplier may not be in compliance with their obligations under the
        *[Code of Conduct for Procurement](https://www.canada.ca/en/public-services-procurement/services/acquisitions/supplier-conduct/code.htm)*
        ;
