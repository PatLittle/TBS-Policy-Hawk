...
* D.2
  ...
  + In providing project approval, Treasury Board agrees that a requirement has been identified and that there is adequate justification for meeting that requirement through the proposed project. Once granted, project approval will establish a distinct project baseline.
    - For Project Complexity and Risk Assessment (PCRA) Level 1, 2, and 3 projects a request for project approval must be supported by an indicative cost estimate, and a cost estimate range or equivalent as approved by the Treasury Board of Canada Secretariat (TBS).
    - For PCRA Level 4 projects, a request for project approval must be supported by the highest cost estimate credibility possible, and not lower than a rough order of magnitude (ROM) cost estimate, and a cost estimate range or equivalent as approved by TBS.
  + Project expenditure authority is the authority to expend funds against project-related activities for which the authority was sought. Project expenditure authority granted by Treasury Board indicates that sufficient information is available, at an appropriate level of detail, to proceed with a set of planned activities within a project phase or phases.
    - For PCRA Level 1, 2, and 3 projects a request for project expenditure authority must be supported by a substantive cost estimate, and a cost estimate range or equivalent as approved by TBS.
    - For PCRA Level 4 projects, a request for project expenditure authority must be supported by the highest cost estimate credibility possible, and not lower than an indicative cost estimate, and a cost estimate range or equivalent as approved by TBS.
  ...
  + D.2.1
    ...
    Departments must seek project expenditure authority in order to commence project definition activities. Project approval from the Treasury Board is not required at this stage of the project. While not part of the expenditure authority approval, a total project cost estimate and cost estimate range are to be provided to TBS for reference.
  ...
  + D.2.4
    ...
    - Appended to the submission:
      ...
      * the Project Brief developed in accordance with Appendix E
    ...
    - Requests for project expenditure authority, or amendments to project expenditure authority must be supported by the following documentation, provided to TBS at the same time as the draft submission:
      * Detailed Project Cost Estimate Range Summary.
      * Detailed Expenditure Authority Cost Estimate Range Summary.
...
* E.2
  ...
  + E.2.5For the recommended option, the scope, schedule, cost, cost estimate range, and other critical objectives that will form the project baseline.
  ...
  + E.2.8The results of the project complexity and risk assessment, and the risk management plan including identification of key risks, their probability and potential impact, and the plan to proactively monitor and control them.
    - As appropriate, an assessment of the risks associated with any discrepancy between available funding and costs.
  ...
  + E.2.14The communications strategy including identification, nature, and extent of consultations with key stakeholders.

  Annexed to the Project Brief: Detailed Project Cost Estimate Range.
...
* F.2.1
  ...
  + F.2.1.3Expenditure authority provides the authority to expend funds against the activities for which the authority was sought.
...
* F.3.1
  ...
  + F.3.1.1Programme approval for the programme, as well as expenditure authority for the definition phase.
  + F.3.1.2As appropriate, a separate expenditure authority to advance implementation activities.
* F.3.2The request for programme approval must be supported by the highest cost estimate credibility possible, and not lower than a rough order of magnitude (ROM) cost estimate, and a cost estimate range or equivalent as approved by TBS.
* F.3.3The request for expenditure authority in support of the definition phase must be supported by the highest cost estimate credibility possible, and not lower than an indicative cost estimate, and a cost estimate range or equivalent as approved by TBS.
* F.3.4
  ...
  + F.3.4.2
    ...
    - The Detailed Expenditure Authority Cost Estimate Range.
...
* F.3.7
  ...
  + F.3.7.3As appropriate, seek authority to approve projects within the tranche that exceed the limits set out in Appendix C: Project Approval Limits of the *Directive on the Management of Projects and Programmes*.
  + F.3.7.4As appropriate, seek associated real property and contracting authorities in keeping with subsection F.7.1.
* F.3.8The updated programme baseline must be supported by the highest cost estimate credibility possible, and not lower than a ROM cost estimate, and a cost estimate range or equivalent as approved by TBS.
* F.3.9The request for expenditure authority in support of a tranche must be supported by the highest cost estimate credibility possible, and not lower than an indicative cost estimate, and a cost estimate range or equivalent as approved by TBS.
* F.3.10
...
* F.6.4
  ...
  + F.6.4.1The underlying tranche capability is delivered.
...
* F.6.6
  ...
  + F.6.6.2This authority is only for the projects related to the tranche for which it is sought and is not transferable. The sponsoring minister must seek this authority for each tranche.
...
* G.2
  ...
  + G.2.6The initial understanding of the estimated cost, cost estimate range, schedule, and resources required to set up, run and manage the programme from definition through to close-out.
  + G.2.7
  ...
  + G.2.12The preliminary procurement strategy and plan and the supporting rationale.
...
* G.3
  ...
  + G.3.6The governance and assurance arrangements that will be applied to the definition phase.
  + G.3.7Key procurement decisions that will be actioned during the definition phase.

  Annexed to the Programme Brief: The Detailed Programme Cost Estimate Range.
...
* H.2
  ...
  + H.2.6The current understanding of the estimated cost, cost estimate range, schedule, and resources required to set up, run and manage the programme from definition through to close-out.
  + H.2.7
  ...
  + H.2.13The proposed timing of engagements with the Treasury Board or TBS.
...
* H.3
  ...
  + H.3.4
    ...
    - H.3.4.2The assurance arrangements that will be deployed in support of the tranche.
  ...
  + H.3.6
    ...
    - H.3.6.3The cost and cost estimate range, including the credibility classification assessment of the estimate.
    - H.3.6.4A summary of the key or critical activities with an associated schedule.
  + H.3.7The stakeholder analysis and engagement required to support the tranche, including the identification, nature and extent of consultations with key stakeholders.
...
* H.4
  ...
  + H.4.3The details of the assurance arrangements that have been or will be put in place to confirm the efficacy of the actions taken to address the gap or gaps.
