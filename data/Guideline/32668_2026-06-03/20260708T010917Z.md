...
- Hierarchy CSV ID: 32668
- Source URL: https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html
- Capture URL: https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html
- Source date: 2026-06-03
- Source date basis: Canada.ca modified date metadata/page details
- Source date URL: https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html
- Captured at (UTC): 2026-07-08T01:09:17Z
- Stored under: Guideline
- Page title: Guideline on Service and Digital

---

# Guideline on Service and Digital
## Note to Reader
Recent amendments to the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf) regarding digital technologies were published on December 17, 2025. These new regulatory requirements strengthen accessibility across Canada and throughout government to ensure that our internal and external digital systems, products and services are accessible and inclusive by design. For interim direction, please refer to the [Government of Canada Chief Information Officer (GC CIO) direction](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html).
The Treasury Board of Canada Secretariat is currently reviewing the Policy on Service and Digital suite of instruments. Pending the completion of this review, the guidelines continue to be relevant; however, note that references in the guideline may not align with the latest policy instruments, including the latest legislations and regulations. Departments should continue to refer to the most current instruments to ensure compliance and consistency. If you have any questions, contact [General Inquiries Service and Digital](mailto:servicedigital-servicesnumerique@tbs-sct.gc.ca).
...
[Appendix A](https://www.canada.ca/en/government/system/digital-government/ToC6) of this Guideline includes the outcomes that departments are expected to achieve by fulfilling the requirements of the Policy and the Directive.
The requirements set out in the Policy and the Directive are guided by the overarching principles and best practices set out in the [Government of Canada Digital Standards](https://www.canada.ca/en/government/system/digital-government/government-canada-digital-standards.html). See how the Digital Standards have influenced different requirements of the Policy and Directive in Appendix B of this Guideline.
The Policy must be applied in conjunction with other policies and legislation, including in the areas of privacy, security, official languages and [accessibility](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html) (see section 8 of the [Policy on Service and Digital](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32603)).
## 1. Integrated governance, planning and reporting
**In this section**
- [1.1 Designation of officials](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_1)
- [1.2 Integrated governance](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_2)
- [1.3 Integrated planning and reporting](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_3)
- [1.4 Enterprise architecture governance](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_4)
- [1.5 Innovation and experimentation](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_5)
...
- increased linkages with other supporting functions across the department (service, IT, information, data, cyber security, privacy and accessibility) that can improve services and operations while meeting privacy, security, accessibility and other obligations
...
- collaborating effectively with other departmental officials and functional communities (such as privacy protection) across the department to improve the department’s services and operations (integrated governance is one way to support these linkages and collaboration between functional areas (see [subsection 1.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_2) of this Guideline)
...
- ensuring that:
- other functions (IT, information, data, cyber security, accessibility, privacy protection) are leveraged
...
- knowledge of government obligations regarding IT, accessibility, information, data, security, cyber security and privacy and how these relate to service
...
- follow legislative and policy requirements for protecting privacy and accessibility
...
- horizontal trends and issues that affect departmental service delivery and operations, to better support individuals’ and businesses’ access to services that are client-centric, disability-inclusive, trusted and secure;
...
- enables assessment of government performance against various priorities such as service improvement, release of open information, accessibility and legacy migration
...
- addresses security and privacy considerations, and digital accessibility obligations
...
Pilots and proof of concepts can be submitted to the GC EARB for review and assessment. GC EARB provides recommendations on new processes and technology when conducting assessments. [Subsection 1.4](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_4) of this guideline has more information on GC EARB assessments.
...
Departments should use fictional data instead of collecting, using or disclosing personal information in an experimental context. Contact your institution’s Access to Information and Privacy (ATIP) office to discuss the requirement for a Privacy Impact Assessment, as required by the [Directive on Privacy Impact Assessment](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=18308). [Subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) of this guideline has more information on specific considerations related to privacy and protection of personal information.
It is also important to prioritize security at the outset of innovation and experimentation activities. For more information on security considerations, see [subsection 4.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_1) of this guideline. In the context of cloud, additional security controls may need to be considered in order to satisfy departmental requirements. For more information on security considerations related to cloud services, see [subsection 4.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_3) of this guideline.
Accessibility is a core program design requirement. As technology and the understanding of disability evolves, there is an opportunity to experiment with new ways of enabling accessibility across the government. This could involve new ways of designing information and communication technology to be accessible or innovative service delivery mechanisms that promote accessibility. See [subsection 3.5](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_5) of this guideline for more information on accessibility requirements. Organizations are strongly encouraged to work with Shared Services Canada and its [Accessibility, Accommodation and Adaptive Computer Technology (AAACT) Program](https://www.canada.ca/en/shared-services/corporate/aaact-program.html) to identify and deploy accessible tools and technology and to remove remaining accessibility barriers associated with IT.
...
**In this section**
- [2.1 Client-centric services](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_1)
- [2.2 Client feedback and satisfaction](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_2)
- [2.3 Online services](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_3)
- [2.4 Real-time application status](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_4)
- [2.5 Service inventory](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_5)
- [2.6 Availability of service inventory on the open governmental portal](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_6)
- [2.7 Service standards](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_7)
- [2.8 Review of service standards](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_8)
- [2.9 Real-time service performance information](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_9)
- [2.10 Service review](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_10)
...
[Appendix C](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8) contains information on service definition, identification and types of services.
...
- The use of digital identity to identify and authenticate users and provide them with more seamless and secure enrolment and access to online services. See [subsection 4.7](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_7) of this guideline for more information.
##### Inclusion
...
##### Accessibility
Recent amendments to the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf) regarding digital technologies were published on December 17, 2025. These new regulatory requirements strengthen accessibility across Canada and throughout government to ensure that our internal and external digital systems, products and services are accessible and inclusive by design. For interim direction, refer to the [GC CIO direction](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html).
When designing services, departments are to ensure that they are barrier-free for all clients by making them inclusive, accessible by default and usable by the broadest range of employees and the public without special adaptation.[Footnote 2](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#fn2).
To that end, departments need to consider integrating the requirements of the [Accessible Canada Act](https://laws-lois.justice.gc.ca/eng/acts/A-0.6/index.html) and [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2021-241/index.html) throughout the design and delivery of their services and systems. This includes:
- taking disability into account in the design and implementation of laws, policies, programs, services and structures
- involving persons with disabilities in the development and design of laws, policies, programs, services and structures that affect them
- developing and publishing plans and feedback mechanisms covering their digital content, systems, programs and services to identify, remove and prevent barriers
- reporting annually on the progress of these plans
Part 1.1 of the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/eng/regulations/SOR-2021-241/index.html) includes requirements that departments should be aware of, and plan to meet within the established timelines set by the regulations:
- New and updated web pages (public- and employee-facing), public-facing mobile applications and public-facing digital documents conform to [CAN/ASC EN 301 549](https://accessible.canada.ca/creating-accessibility-standards/canasc-en-301-5492024-accessibility-requirements-ict-products-and-services)
- Accessibility statements are published regarding regulated web pages, mobile applications and digital documents
- Conformance assessments against [CAN/ASC EN 301 549](https://accessible.canada.ca/creating-accessibility-standards/canasc-en-301-5492024-accessibility-requirements-ict-products-and-services) are obtained when procuring products or services related to regulated web pages or mobile applications
Departments should refer to the [Guidance on Digital Technologies Accessibility Regulations](https://www.canada.ca/en/employment-social-development/programs/accessible-canada-regulations-guidance/category-digital-technologies.html) to better understand how to comply with the requirements under Part 1.1 of the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf).
Refer to [subsection 3.5](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_5) of this guideline for specific considerations related to accessibility and the [Digital Accessibility Toolkit](https://a11y.canada.ca/en/). If additional support is needed, consult with Shared Services Canada’s Accessibility, Accommodations and Adaptive Computer Technology Programs (AAACT) for more information on digital accessibility.
##### Security
...
See [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) of this guideline for more information on specific considerations related to privacy.
##### Simplicity
...
- Ensuring that privacy- and security-related considerations are addressed at the design stage. For more information, refer to [subsection 4.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_1) of this guideline.
...
- Leverage trusted digital identity to identify and authenticate users, and to provide more seamless and secure enrolment and access to online services. For more information on digital identity considerations, refer to [subsection 4.7](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_7) of this guideline.
- The [Standard on Web Usability](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=24227) ensures that Government of Canada websites and web applications respect usability principles and approaches. New websites and web applications must meet the requirements of Section 6 of the standard when they are published. Refer to subsection 3.5 of this guideline on specific requirements regarding web site accessibility. In addition, [Technical Specifications for the Web and Mobile Presence](https://www.canada.ca/en/treasury-board-secretariat/services/government-communications/federal-identity-program/technical-specifications/web-mobile-presence.html) describe how to optimize:
...
When designing online services, consider the use of application program interfaces (APIs) as a means to facilitate this work. Refer to [subsection 3.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_3_1) of this guideline for further details.
##### User engagement
...
- [Immigration, Refugees and Citizenship Canada](https://www.canada.ca/en/immigration-refugees-citizenship/services/application.html)
...
As a first step, departments can review their annual Departmental Report, Program Inventory and website to identify a list of the department’s services. Services could include typical external services that most departments offer, such as public enquiries and access to information and privacy requests. Once a list of potential services is established, use the Service Identification Tool described in [Appendix C](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8) of this guideline to confirm whether the activities undertaken are indeed services. You can also refer to the definition of services in [Appendix C](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8) and to the instructions below on developing a service inventory.
...
- review the Service Identification Tool (see [Appendix C](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8) of this guideline)
...
- requirements 4.3.2.8 and 4.3.2.9 of the Policy on Service and Digital to release information and data on the open government portal (refer to [subsection 3.4](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_4) of this guideline for more information)
...
- [Cabinet Directive on Regulation](https://www.canada.ca/en/treasury-board-secretariat/services/federal-regulatory-management/guidelines-tools/cabinet-directive-regulation.html)
...
Refer to the table in [subsection 2.9](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_9) of this guideline for examples of service performance metrics.
...
Service standards should address different aspects and channels (for example, in person, telephone and online) of service delivery, as appropriate. | | |
| Is there an access standard?
Service standards should outline a commitment for the ease and convenience the client should experience when attempting to access a service. | | |
| Is there a timeliness standard?
Service standards should outline a commitment stating how long the client should expect to wait to receive a service once the service has been accessed. | | |
| Is there an accuracy standard?
Service standards should outline a commitment stipulating that the client will receive a service that is up-to-date, free of errors and complete. | | |
| Do the standards align with client needs and expectations?
Service standards should take into consideration the needs and expectations of clients to ensure that they are meaningful. This can be done through public opinion research and consultations with clients. | | |
| Are the service standards based on consultations with various stakeholders?
Service standards should be developed and updated in consultation with clients, managers, staff and other stakeholders in service delivery. | | |
| Are the service standards measurable?
Service standards should be quantifiable and linked to broader performance monitoring activities. | | |
| Do the standards align with specific requirements contained in applicable legislation and policies?
Service standards should meet specific provisions as articulated in legislation and policy (where applicable) (for example, the Policy on Transfer Payments, the Service Fees Act,the Directive on Charging and Special Financial Authorities,the Cabinet Directive on Regulationandassociated policies and guidance documents). | | |
| Are the service standards consistent with those of similar services?
Similar services offered by various programs, departments and jurisdictions should have similar standards where appropriate. Clients will find it easier to deal with different organizations, and the organizations themselves will find it easier to share best practices and adopt common approaches. | | |
| Are the service standards realistic (for example, reasonable and practical)?
Service standards should be sufficiently challenging to service providers yet attainable in terms of resources and overall departmental capacity (that is, operational capacity, business processes or systems) to meet the standards. | | |
| Are the service standards endorsed by management?
Service standards should be understood and endorsed by senior management. | | |
| Are the service standards and related performance results available to staff, management, clients and stakeholders?
Service standards and related performance results should be available to employees, senior management, clients and other stakeholders to help manage expectations and performance. | | |
...
Service standards, current status and performance reporting should be presented online clearly, simply and consistently so that citizens and clients know what to expect when accessing a service. | | |
| Have the service standards been reviewed and updated within the service review period (i.e. at least every five years)?
Service standards should be regularly reviewed and updated using this tool and within the period of the service review, or sooner, as appropriate. See [subsection 2.10](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_10) of this guideline for more information about service review. | | |
| Is real-time performance information related to service standards being published?
Real-time service performance information should be linked to service standard targets. | | |
...
8. Once approved, the service redesign and optimization initiatives should be reflected in your department’s key planning documents, including the required integrated plan, as appropriate. Refer to [subsection 1.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_3) of this guideline for further details on integrated planning.
...
**In this section**
- [3.1 Strategic management of information and data](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_1)
- [3.2 Use of digital systems to manage information](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_2)
- [3.3 Enabling interoperability](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_3)
- [3.4 Release of information and data on the open government portal](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_4)
- [3.5 Accessibility by design](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_5)
- [3.6 Privacy and protection of personal information](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6)
...
Refer to [Appendix](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8)D of this guideline for a definition and description of the terms information and data, in the context of the Policy on Service and Digital and the Directive on Service and Digital.
...
- Use digital systems to create, collect, manage, use and share information and data. Refer to [subsection 3.2](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_2_1) of this guideline for more information on the use of digital systems. Ensure that the systems used for the creation and collection of information and data:
...
- Respect information and data security and privacy requirements when creating, collecting, and using information and data. Refer to [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) and [subsection 4.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_6) of this guideline for more information on specific considerations for privacy and security. Specifically, in relation to security, also consult the [Mandatory Procedures for Information Management Security Control](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32611&section=procedure&p=B).
...
- Adopting a “cloud first” approach to storing information and data categorized at the Protected B level or below, as outlined in [subsection 4.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_3) of this guideline.
- Ensuring that all government-held sensitive information and data categorized as Protected B, Protected C or Classified reside within the geographic boundaries of Canada or within the premises of a Government of Canada department located abroad (for example, diplomatic or consular mission), as outlined in [subsection 4.4](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_4) of this guideline.
...
- Map out and analyze existing business processes, and implement automation, auto-classification, machine learning and artificial intelligence, wherever feasible. Refer to [subsection 4.5](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_5) of this guideline for more information on specific considerations related to automated decision-making.
...
- If personal information is shared within or outside of a department, the development of an information-sharing agreement is to be considered (see [Guidance on Preparing Information Sharing Agreements Involving Personal Information](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/privacy/guidance-preparing-information-sharing-agreements-involving-personal-information.html#wb-cont)) in order to ensure that the sharing of personal information complies with applicable privacy legislation and policy. Refer to [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) of this guideline for more information on specific considerations related to privacy.
...
Lastly, publication of information on the open government portal must adhere to the requirements in the [Open Government Guidebook](https://open.canada.ca/ckan/en/dataset/9eaa6d0e-4b8c-5241-acf7-c6885294b8c1).
### 3.5 Accessibility by design
#### 3.5.1 Description and associated requirements
Recent amendments to the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf) regarding digital technologies, published on December 17, 2025, require departments to design digital content and systems to be accessible from the start and to build digital accessibility capacity. For interim direction, refer to the [GC CIO direction](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html).
More specifically, Part 1.1 of the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf) states that departments must, by the timelines set by the regulations:
- ensure that their new and updated web pages (public- and employee-facing), public-facing mobile applications and public-facing digital documents conform to [CAN/ASC EN 301 549](https://accessible.canada.ca/creating-accessibility-standards/canasc-en-301-5492024-accessibility-requirements-ict-products-and-services)
- publish accessibility statements regarding regulated web pages, mobile applications and digital documents
- assess all their mobile applications that were launched before December 5, 2028, for conformance with [CAN/ASC EN 301 549](https://accessible.canada.ca/creating-accessibility-standards/canasc-en-301-5492024-accessibility-requirements-ict-products-and-services)
- provide training on digital accessibility fundamentals to employees involved in the design, maintenance or procurement of digital technologies
- conduct or obtain conformance assessments against [CAN/ASC EN 301 549](https://accessible.canada.ca/creating-accessibility-standards/canasc-en-301-5492024-accessibility-requirements-ict-products-and-services) when procuring products or services related to regulated web pages or mobile applications
Departments should refer to the [Guidance on Digital Technologies Accessibility Regulations](https://www.canada.ca/en/employment-social-development/programs/accessible-canada-regulations-guidance/category-digital-technologies.html) on the timelines for the coming into force of these requirements and to better understand how to comply with the new digital accessibility requirements of the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf).
...
More detailed guidance on privacy protection can be found in the policies and directives issued in support of the administration of the [Privacy Act](https://laws-lois.justice.gc.ca/ENG/ACTS/P-21/index.html).
Requirements for departments under the Policy
Deputy heads are responsible for:
...
Departments should also consult the [Standard on Security Event Reporting](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32613&section=html) and the [Government of Canada Cyber Security Event Management Plan](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/security-identity-management/government-canada-cyber-security-event-management-plan.html).
For more information on managing cyber security events, refer to [subsection 4.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_6) of this guideline.
## 4. Leveraging technology
**In this section**
- [4.1 Considerations at the design stage](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_1)
- [4.2 Digitally enabled operations](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_2)
- [4.3 Cloud services](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_3)
- [4.4 Data residency](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_4)
- [4.5 Automated decision-making](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_5)
- [4.6 Cyber security](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_6)
- [4.7 Digital identity](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_7)
...
- [Policy on Service and Digital direction from the GC CIO](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html)
- [Directive on the Management of Procurement](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32692)
Departments should refer to the [Guidance on Digital Technologies Accessibility Regulations](https://www.canada.ca/en/employment-social-development/programs/accessible-canada-regulations-guidance/category-digital-technologies.html) on the timelines for the coming into force of the requirements and to better understand how to comply with the new digital accessibility requirements of the Accessible Canada Regulations.
##### Official languages
When procuring or developing ICT solutions and equipment, the following should be taken into consideration at the design stage:
...
- [Policy on Privacy Protection](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=12510)
Refer to [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) of this guideline for information on specific considerations related to privacy and protection of personal information.
##### Environment
When procuring or developing ICT solutions and equipment, the following should be taken into consideration at the design stage:
...
Refer to [subsection 4.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_6) of this guideline for information on specific considerations related to cyber security.
The above considerations are also key elements of providing client-centric services, which is discussed in detail in [subsection 2.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_1) of this guideline.
### 4.2 Digitally enabled operations
#### 4.2.1 Description and associated requirement
The Policy on Service and Digitaldefines digitally enabled operations as operations that are supported by strategically leveraging information and communications technologies, infrastructures, and the information and data they produce and collect. Simply put, this means that the government takes advantage of modern, digital means to operate and deliver services to Canadians. Doing so includes operating in a [digital-first and integrated environment](https://www.canada.ca/en/government/system/digital-government/digital-operations-strategic-plan-2018-2022.html#ToC9) and supporting workers with [digital tools](https://www.canada.ca/en/government/system/digital-government/digital-operations-strategic-plan-2018-2022.html#ToC11) to facilitate efficiency and effectively deliver on the goals of the Government of Canada.
...
See [subsection 2.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC2_3) of this guideline for more information on online services.
...
- Implementing considerations (e.g., security, privacy, accessibility) at the design stage according to [subsection 4.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_1) of this guideline so as to continually maintain and operate services and programs and reduce likelihood of system failures.
...
- Where relevant, leveraging a cloud-first approach, as outlined in [subsection 4.3](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_3) of this guideline.
...
- Linking these activities to departmental governance and decision-making processes. See [subsection 1.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC1_2) of this guideline for more information.
### 4.3 Cloud services
...
Cloud services must also be used in compliance with privacy-related laws and policies. Refer to [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6) of this guideline for information on privacy and protection.
Finally, the Government of Canada provides a consolidated [cloud services landing page](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services.html) for all public-facing cloud documentation, including strategy, risk assessments and interpretation of existing policies in the context of cloud.
### 4.4 Data residency
...
- [Government of Canada White Paper: Data Sovereignty and Public Cloud](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services/gc-white-paper-data-sovereignty-public-cloud.html)
...
Cyber security operationalizes the IT security controls set out in subsection B.2.3 of Appendix B of the [Directive on Security Management](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32611).
...
- Critical services are identified and plans are in place to ensure continued delivery, in accordance with the Directive on Security Management, [Appendix D: Mandatory Procedures for Business Continuity Management Control](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32611&section=procedure&p=D)
...
- Establish a plan to ensure that vulnerabilities are managed, and promptly apply security-related patches and updates, including emergency patches. Regularly test for the presence of known vulnerabilities and common configuration errors. For more information, refer to [Patch Management Guidance](https://www.canada.ca/en/government/system/digital-government/online-security-privacy/patch-management-guidance.html)
...
- Leveraging digital identity services that support Government of Canada–approved trust frameworks, such as the [Pan-Canadian Trust Framework](https://github.com/canada-ca/PCTF-CCP/blob/master/README.md), and standards, such as the [Digital Trust and Identity: Part 1 (CAN/CIOSC 103-1:2020)](https://ciostrategycouncil.com/standards/103_1_2020/), in accordance with the [Directive on Identity Management](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=16577). For more information, refer to [subsection 4.7](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_7) of this guideline
...
- Physical access to systems, supporting infrastructure and facilities is restricted to authorized personnel, in accordance with the Directive on Security Management, [Appendix C: Mandatory Procedures for Physical Security Control](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32611&section=procedure&p=C)
###### Data security
- Systems adequately protect data at rest and data in transit using approved cryptographic protection. For more information, refer to [Guidance on Securely Configuring Network Protocols (ITSP.40.062)](https://www.cyber.gc.ca/en/guidance/guidance-securely-configuring-network-protocols-itsp40062) and [Cryptographic Algorithms for Unclassified, Protected A, and Protected B Information (ITSP.40.111)](https://www.cyber.gc.ca/en/guidance/cryptographic-algorithms-unclassified-protected-and-protected-b-information-itsp40111)
- Appropriate sanitization or destruction measures are put in place before reuse or disposal of the equipment. Such measures are commensurate with the sensitivity of the information stored and in accordance with departmental practices. For more information, refer to [IT Media Sanitization (ITSP.40.006)](https://cyber.gc.ca/en/guidance/it-media-sanitization-itsp40006)
###### Protective technology
- Ensure a management system for audit logs is implemented that includes auditing of sensitive actions or data exchange or access. For more information, refer to the [Event Logging Guidance](https://www.canada.ca/en/government/system/digital-government/online-security-privacy/event-logging-guidance.html)
- Technology that is configured to limit services exposed and information exchanged to the minimum necessary is implemented. Such technology ensures that only trusted and supported operating systems, applications and computer code can execute on systems. The configurations outlined in the Directive on Service and Digital, [Appendix G: Standard on Enterprise IT Service Common Configurations](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32713) should be respected
...
###### Detection processes
- Define roles and responsibilities for detection, in alignment with the [GC CSEMP](https://www.canada.ca/en/government/system/digital-government/online-security-privacy/security-identity-management/government-canada-cyber-security-event-management-plan.html)
...
- security configuration requirements outlined in [IT configurations](https://www.canada.ca/en/government/system/digital-government/policies-standards/enterprise-it-service-common-configurations.html) under Appendix G: Standard on Enterprise IT Service Common Configurations
...
- [Security of online government services](https://www.canada.ca/en/government/system/digital-government/online-security-privacy.html)
- [Security Playbook for Information System Solutions](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/cloud-services/security-playbook-information-system-solutions-cloud.html)
...
- [Guideline on Identity Assurance](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=30678&section=html) and the [Government of Canada Guidance on Using Electronic Signatures](https://www.canada.ca/en/government/system/digital-government/online-security-privacy/government-canada-guidance-using-electronic-signatures.html)
...
- Ensure that privacy and security-related considerations are addressed from beginning to end. For more information, refer to [subsection 3.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC3_6), [subsection 4.1](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_1) and [subsection 4.6](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC4_6) of this guideline.
## 5. Supporting workforce capacity and capability
**In this section**
- [5.1 Workforce awareness, capacity and capability](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC5_1)
- [5.2 Chief information officer talent management and community development initiatives](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC5_2)
...
Recent amendments to the [Accessible Canada Regulations](https://laws-lois.justice.gc.ca/PDF/SOR-2021-241.pdf) regarding digital technologies were published on December 17, 2025, and contain new requirements for training. Refer to the [direction by the GC CIO](https://www.canada.ca/en/government/system/digital-government/policies-standards/policy-service-digital-announcements/direction-information-communication-technologies-accessibility-towards-regulatory-implementation.html) and the [guideline in support of the new regulations](https://www.canada.ca/en/employment-social-development/programs/accessible-canada-regulations-guidance/category-digital-technologies.html).
...
| Design with users Research with users to understand their needs and the problems we want to solve. Conduct ongoing testing with users to guide design and development. | Directive on Service and Digital 4.2.1.1: Ensuring that client feedback, including in-service client feedback, client satisfaction surveys and user experience testing, is collected and used to improve services according to TBS direction and guidance. |
| --- | --- |
| Iterate and improve frequently Develop services using agile, iterative and user-centred methods. Continuously improve in response to user needs. Try new things, start small and scale up. | Directive on Service and Digital 4.2.1.1: Ensuring that client feedback, including in-service client feedback, client satisfaction surveys and user experience testing, is collected and used to improve services according to TBS direction and guidance. Directive on Service and Digital 4.2.1.7: Ensuring that each service is regularly reviewed with clients, partners and stakeholders, in collaboration with the departmental CIO, as appropriate, at least once every five years to identify opportunities for improvement, including redesign for client-centricity, digital enablement, online availability and uptake, efficiency, partnership arrangements, and alternate approaches to service delivery. |
| Work in the open by default Share evidence, research and decision making openly. Make all non-sensitive data, information, and new code developed in delivery of services open to the outside world for sharing and reuse under an open licence. | Policy on Service and Digital 4.3.2.8: Maximizing the release of departmental information and data as an open resource, discoverable through the Government of Canada open government portal designated by the Treasury Board of Canada Secretariat, while respecting information security, privacy, and legal considerations. Policy on Service and Digital 4.3.2.9: Prioritizing departmental information and data to be added to the Government of Canada’s open government portal, informed by public demand. |
| Use open standards and solutions Leverage open standards and embrace leading practices, including the use of open source software where appropriate. Design for services and platforms that are seamless for Canadians to use no matter what device or channel they are using. | Policy on Service and Digital 4.3.1.1: Prescribing enterprise-wide information and data standards for quality, accessibility, and data interoperability, including common architecture taxonomies and classifications, quality requirements, and life cycle management direction. |
| Address security and privacy risks Take a balanced approach to managing risk by implementing appropriate privacy and security measures. Make security measures frictionless so that they do not place a burden on users. | Policy on Service and Digital 4.3.2.5: Ensuring that, when managing personal information or data, including in the context of data interoperability, the privacy of individuals is protected according to the Privacy Act and any other relevant legislation, policy or agreement. Policy on Service and Digital 4.3.2.6: Ensuring that privacy is addressed in the context of any plan or strategy to manage departmental information or data. Policy on Service and Digital 4.3.2.7: Ensuring that sensitive information under the department’s control is protected according to the Policy on Government Security and any relevant legislation, policy or agreement. Policy on Service and Digital 4.4.1.8: Defining cyber security requirements to ensure that Government of Canada and departmental information and data, applications, systems, and networks are secure, reliable and trusted. |
| Build in accessibility from the start Services should meet or exceed accessibility standards. Users with distinct needs should be engaged from the outset to ensure what is delivered will work for everyone. | Policy on Service and Digital 4.2.1.1: Ensuring the development and delivery of client-centric service by design, including access, inclusion, accessibility, security, privacy, simplicity, and choice of official language. Policy on Service and Digital 4.4.2.2: Ensuring that, for newly procured or developed information, communication, and technology solutions and equipment, applicable requirements or standards regarding accessibility, official languages, protection of personal information, the environment, and security are addressed by design. |
| Empower staff to deliver better services Make sure that staff have access to the tools, training and technologies they need. Empower the team to make decisions throughout the design, build and operation of the service. | Policy on Service and Digital 4.4.2.5: Providing authorized users of the departmental electronic network and of departmental devices with open access to the Internet, including Government of Canada and external Web 2.0 tools and services that enhance productivity, communication and open collaboration, in accordance with the Policy on Government Security, and limiting access only where necessary to manage security risks and address unacceptable uses. Policy on Service and Digital 4.5.2.1: Ensuring departmental workforce awareness, capacity, and capability to meet departmental and enterprise service, information, data, IT, and cyber security requirements. |
| Be good data stewards Collect data from users only once and reuse wherever possible. Ensure that data is collected and held in a secure way so that it can easily be reused by others to provide services. | Policy on Service and Digital 4.3.1.1: Prescribing enterprise-wide information and data standards for quality, accessibility, and data interoperability, including common architecture taxonomies and classifications, quality requirements, and life cycle management direction. Policy on Service and Digital 4.3.2.1: Ensuring that information and data are managed as a strategic asset to support government operations, service delivery, analysis and decision-making. |
| Design ethical services Make sure that everyone receives fair treatment. Comply with ethical guidelines in the design and use of systems which automate decision making (such as the use of artificial intelligence). | Policy on Service and Digital 4.4.2.4: Ensuring the responsible and ethical use of automated decision systems, in accordance with TBS direction and guidance, including: Policy on Service and Digital 4.4.2.4.1: Ensuring decisions produced using these systems are efficient, accountable, and unbiased; and, Policy on Service and Digital 4.4.2.4.2: Ensuring transparency and disclosure regarding use of the systems and ongoing assessment and management of risks. |
| Collaborate widely Create multidisciplinary teams with the range of skills needed to deliver a common goal. Share and collaborate in the open. Identify and create partnerships which help deliver value to users. | Policy on Service and Digital 4.5.1.1: Providing enterprise-wide leadership on the development and sustainability of the information and IT functional community by using talent management and community development strategies. Policy on Service and Digital 4.5.2.1: Ensuring departmental workforce awareness, capacity, and capability to meet departmental and enterprise service, information, data, IT, and cyber security requirements. Directive on Service and Digital 4.5.1.1: Providing functional leadership in the department on the development and sustainability of the IT and information communities through talent management and community development strategies. |
## Appendix C: Client-Centric Services
**In this section**
- [C.1 Key terms and concepts](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_1)
- [C.2 Service management](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_2)
- [C.3 Service types](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3)
- [C.4 – Service Agreements](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_4)
...
Also consult the table on [Service Output Types](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2), as it identifies a broad range of services, including regulatory authorizations and penalties, that are also considered to be services.
...
| --- | --- | --- |
| Does a specific activity result in a final output to recipients or clients? | The funding is the final product of the service and is what farmers were seeking when they originally applied and paid for the service. The distribution of funds is the final output. | Yes |
| Are there clearly defined clients or recipients? | The clients are farmers. | Yes |
| Are there multiple clients and recipients? | There are many farmers who could use this service. | Yes |
| Is the final output produced repeatedly? | The funding is given repeatedly and in different years. | Yes |
| Are the activities contributing to the achievement of an outcome that is independent of any other service? | AgriStability does not require additional activities or processes to ensure that it contributes to a program outcome. It also does not depend on other services. | Yes |
| Does the activity meet the “materiality test” of supporting the well-being of individuals and/or the effective operation of organizations? | It provides funding when producers production margins fall below their reference margin by more than 30%. | Yes |
...
| Questions | Analysis | Yes/No |
| --- | --- | --- |
| Does a specific activity result in a final output to recipients or clients? | The icebreaking and the protection that goes along with icebreaking are the services that the client has requested and paid for. It is the final output. | Yes |
| Are there clearly defined clients or recipients? | Potential clients could be shipping companies or the general public. | Yes |
| Are there multiple clients and recipients? | This service is provided to many clients: commercial vessels, Arctic residents, port operators and the general public. | Yes |
| Is the final output produced repeatedly? | The ice is cleared many times during the winter, year after year. | Yes |
| Are the activities contributing to the achievement of an outcome that is independent of any other service? | Icebreaking does not depend on other services. | Yes |
| Does the activity meet the “materiality test” of supporting the well-being of individuals and/or the effective operation of organizations? | It supports economic activities by assisting commercial vessels to voyage efficiently and safely through or around ice-covered waters. | Yes |
Conclusion: This is a service.
...
For further details, consult Service Canada’s [Canada Benefits](https://www.canada.ca/en/services/benefits.html) web page.
| Questions | Analysis | Yes/No |
| --- | --- | --- |
| Does a specific activity result in a final output to recipients or clients? | The website is a tool that identifies various benefit programs and services based on target group and life events. It provides links to other websites. It is therefore an intermediate output, rather than a final output to a client. | No |
...
- Does the provision of information or data represent a final output? Is the information or data the final output, or is it part of a larger process that leads to a final output? The greater the sense that the information or data is the final output, the greater the likelihood it is a service. For example, the weather forecast published to the weather website is a service because the information concludes an interaction between the service provider (the weather website) and the client (the website visitor). The interaction is concluded because the client obtains the weather forecast as a final output.
- How frequently is the information or data produced? For information to be considered a service, the final output must be produced frequently or repeatedly. The more frequently the information or data is produced, the greater the likelihood that it is a service.
- How great is the need for the information? The greater the recipient’s need for the information, the greater the likelihood that the provision of it is a service. Consider whether access to the information helps ensure the well-being, health and safety of Canadians or economic viability of businesses and whether the lack of access to it could hinder this. For example, travel advisories or food recall warnings published to the Internet are services.
- Is there a timeliness factor associated with the need? The greater the need for the information in a specified time frame, the greater the likelihood that it is a service. For example, the weather website publishes information about the weather forecast with a high degree of frequency. Contrast this to a report or document that is published on the website only once a year.
- How many individuals or organizations access the information or data? The greater the number of individuals that access the information or data as a final output, the greater the likelihood that it is a service. Given the wide range of services offered by the federal government, it is impossible to establish a threshold number because that number depends highly on the nature of the service and the operational context.
- Does the provision of information or data contribute directly to the achievement of an outcome? Answering yes to this question increases the likelihood that the provision of the information or data is a service. For example, a call centre agent providing information or advice in the form of a final output contributes directly to an outcome; the client has obtained customized information and advice needed to access government programs and services.
...
- Service recipient
- [Services external to government](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_1_1)
- [Services internal to government](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_1_2)
- Internal to departments
- Interdepartmental
- Internal Enterprise
- Service output
- [19 service types as identified in the Canadian Governments Reference Model (CGRM)](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1)
...
- [Funds; an amount of money](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1a)
- [Resources; a unit of resource](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1b)
- [New knowledge (can also be called intellectual property)](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1c)
- [Care and rehabilitation encounters; a care and rehabilitation encounter](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1d)
- [Educational and training encounters; an educational and training encounter](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1e)
- [Recreational and cultural encounters; a recreational and cultural encounter](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1f)
- [Movements; a movement of a person or resource](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1g)
- [Advisory encounters; an advisory encounter (also known as an information encounter)](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1h)
- [Matches, referrals and linkages; a match, referral or linkage](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1i)
- [Advocacy and promotional encounters; an advocacy or promotional encounter](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1j)
- [Periods of agreement; a period of agreement](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1k)
- [Periods of permission; a period of permission granted by an authority](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1l)
- [Findings; a finding](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1m)
- [Rulings and judgments; a ruling or judgment](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1n)
- [Penalties and periods of sanction; a penalty or period of sanction](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1o)
- [Periods of protection; a period of protection](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1p)
- [Interventions; an intervention](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1q)
- [Rules (laws, regulations, policies, strategies, plans, designs, standards); a rule](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1r)
- [Implemented changes; an implemented change may also be called a project](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC8_3_2_1s)
1. Funds; an amount of money
blockquote Examples:
/blockquote
blockquote Examples of Government of Canada services:
/blockquote
...
For service agreements that involve personal information, refer to [Guidance on Preparing Information Sharing Agreements Involving Personal Information](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/privacy/guidance-preparing-information-sharing-agreements-involving-personal-information.html).
## Appendix D: Information and data
**In this section**
- [Comparing the terms](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#ToC9_1)
### Comparing the terms
...
For additional guidance on how to meet the requirements of the Standard for Systems that Manage Information and Data and the Standard for Managing Metadata, please refer to the [Information and Data Management](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/information-management.html) page.
...
As stated in the Directive on Service and Digital, it is the departmental CIO’s responsibility to identify information and data of business value in their organization. Refer to [Guidance on Identifying Information of Business Value](https://gcxgce.sharepoint.com/teams/10001115/GCconnex%20archive/Forms/AllItems.aspx?id=%2Fteams%2F10001115%2FGCconnex%20archive%2F061%2DGuidance%2DIdentifying%5FInformation%5Fof%5FBusiness%5FValue%2Dv2019%2DIN%2DREVIEW%2Epdf&parent=%2Fteams%2F10001115%2FGCconnex%20archive&xsdata=%3D%3D&sdata=V0NVbXZTNm9mRUZjMUFSRE5KL2xkQ1lMTDNwckFaQmthdlhaTFBhdGU3UT0%3D&clickparams=eyAiWC1BcHBOYW1lIiA6ICJNaWNyb3NvZnQgT3V0bG9vayIsICJYLUFwcFZlcnNpb24iIDogIjE2LjAuMTk5MjkuMjAxNzIiLCAiT1MiIDogIldpbmRvd3MiIH0%3D) (available only on the GC network) for more information. While many departments will have identified the same or similar information and data as having business value (for example, memoranda, briefing notes, records of decision), it is necessary to examine the specific functions and activities of the organization in order to arrive at an accurate listing of what has business value. It is then up to managers to inform employees of their duty to document activities and decisions of business value and employees to carry out that requirement in their daily work.
...
## Footnotes
**Footnote 1**: Throughout this guideline, federal departments and agencies are referred to as departments.
[Return to footnote 1 referrer](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#fn1-rf)
**Footnote 2**: Does not preclude adaptation for specialized needs in specific circumstances.
[Return to footnote 2 referrer](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#fn2-rf)
**Footnote 3**: The limits of the term ‘raw’ as a metaphor for data that hasn’t been processed or analyzed are worth noting: even when it is collected by a sensor or other automated mechanism, data bears the assumptions, biases, and methodological constructs of those who designed and engineered its collection. The concept of ‘raw’ in this context is only useful to help the reader distinguish between data and information. It is not intended to refer to an idealized, neutral state of data that is somehow independent of human intervention.
[Return to footnote 3 referrer](https://www.canada.ca/en/government/system/digital-government/guideline-service-digital.html#fn3-rf)
